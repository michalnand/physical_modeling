...
lorenz_training = pyphy.Lorenz(100, 2000)
lorenz_training.save("data/training.dat")

lorenz_testing = pyphy.Lorenz(100, 2000)
lorenz_testing.save("data/testing.dat")



#load dataset
dats_training   = pyphy.DatsLoad("data/training.json")
dats_testing    = pyphy.DatsLoad("data/testing.json")
...
training_trajectory = pyphy.DatsToTrajectory(dats_training, "data/dataset_particles_motion_spatial_config.json")
testing_trajectory = pyphy.DatsToTrajectory(dats_testing, "data/dataset_particles_motion_spatial_config.json")
print("loading done")
...
dataset = pyphy.DatasetParticlesMotion( training_trajectory.get_trajectory_input(),
                                        ...
                                        "data/dataset_particles_motion_spatial_config.json")
